...
export class Router {
   ...
   * @since 0.1.0
   */
  private addRoute(method: HttpMethod, path: string, handler: RouteHandler, middlewares: Middleware[] = []): Router {
   ...
   * @since 0.1.0
   */
  findRoute(method: HttpMethod, path: string): { route: Route; params: Record<string, string> } | null {
