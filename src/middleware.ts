...
import type { Middleware, NinoContext, HttpMethod } from './types';
...
export function rateLimit(options: {
  ...
  const {
    ...
    keyGenerator = (context) => context.headers.get('x-forwarded-for') || 
 ...
 * @since 0.1.0
 */
export function staticFiles(directory: string, options: {
  /** 
